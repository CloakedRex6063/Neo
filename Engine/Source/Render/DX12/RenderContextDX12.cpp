...
namespace Neo
{
    ...
    ShaderHandle RenderContextDX12::CreateShader(const GraphicsShaderCreateInfo& createInfo, std::string_view debugName)
    {
    ...
    ShaderHandle RenderContextDX12::CreateShader(const ComputeShaderCreateInfo& createInfo, std::string_view debugName)
    {
    ...
    void RenderContextDX12::BeginRenderPass(const CommandHandle commandHandle, const RenderPassInfo& renderPassInfo)
    {
        ...
        commandList->BeginRenderPass(renderPassInfo.RenderTargets.size(),
                                     ...
                                     renderPassInfo.DepthStencil != DepthStencilHandle::eNull ? &depthStencilDesc
                                                                                              : nullptr,
    ...
    void RenderContextDX12::ChooseGPU()
    {
        ...
        const auto chooseResult = mFactory->EnumAdapterByGpuPreference(0, preference, IID_PPV_ARGS(&mAdapter));
        DX12::ThrowIfFailed(chooseResult, "No GPU found");
        ...
        Log::Info("Dedicated Memory: {} GB", static_cast<float>(desc.SharedSystemMemory) / 1024 / 1024 / 1024);
    ...
    ResourceHandle
    RenderContextDX12::CreateResource(DX12::Heap& heap, const BufferCreateInfo& createInfo, std::string_view debugName)
    {
        const D3D12_RESOURCE_DESC resourceDesc{
                                                                 ...
                                                                 const BufferCreateInfo& createInfo)
    {
        ...
        const D3D12_SHADER_RESOURCE_VIEW_DESC viewDesc = {.Format = DXGI_FORMAT_UNKNOWN,
    ...
    {
        const auto& [BaseResource, ResourceState] = mResources.at(static_cast<u32>(resourceHandle));
        const D3D12_SHADER_RESOURCE_VIEW_DESC viewDesc = {.Format = DX12::GetFormat(createInfo.Format),
